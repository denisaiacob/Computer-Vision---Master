...
# load the image
img_to_detect = cv2.imread('people.jpg')
...
# NMS is used to minimize the Number of bounding boxes in the image,
# because sometimes there are two or more bounding boxes around the same object without NMS
############## NMS Change 1 ###############
